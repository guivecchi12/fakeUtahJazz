...
export default function Home() {
  return (
    <>
      ...
      <div className="fixed z-50 flex flex-col items-center w-full text-white bg-black">
        <Header />
      ...
      <div className="flex flex-col items-center justify-center w-full text-white bg-black">
        <div className="flex flex-col items-center justify-center w-4/5 pb-24">
          <div className="flex flex-col items-center justify-center w-4/5 py-5 mt-24 text-center">
            ...
            <h3 className="py-5 text-3xl text-yellow-300">
            ...
            <Link href="#contact_us">
              <button className="px-3 py-1 my-10 text-yellow-300 duration-300 ease-in border border-yellow-300 rounded hover:bg-yellow-300 hover:text-black">
                Contact Us
              </button>
            </Link>
          </div>
        ...
        <div className="flex items-center justify-center md:bg-white">
          <div className="relative flex flex-col items-center justify-center h-full bottom-20 md:flex-row">
            <div className="flex flex-col w-full bg-black md:border md:border-solid md:mr-10 md:w-1/3">
              <div className="bg-center bg-cover h-52 bg-eide"></div>
              <div className="flex flex-col justify-center px-14 md:h-[375px]">
                ...
                <p>
                  ...
                  advantage over your competitors. It offers the chance to
                  communicate your message in a luxurious setting while making
                  entertaining as easy as it is elegant. Take advantage of the
                  most unique and exciting way to entertain in Utah by becoming
                  a Vivint Arena luxury suite holder.
                </p>
                <Link href="">
                  <button className="px-3 py-1 my-4 text-yellow-300 duration-300 ease-in border border-yellow-300 rounded md:my-3 mt-9 w-fit hover:bg-yellow-300 hover:text-black">
                    Learn More
                  </button>
                </Link>
              </div>
            ...
            <div className="flex flex-col w-full bg-black md:border md:border-solid md:w-1/3">
              <div className="bg-center bg-cover h-52 bg-exclusive"></div>
              <div className="flex flex-col justify-center px-14 md:h-[375px]">
                <h4 className="py-5 text-xl text-yellow-300">
                  EXCLUSIVE CLUBS
                </h4>
                <p>
                  Membership into one of our exlusive clubs can enhance your
                  corporate profile and give you an advantage over your
                  competitors. It offers the chance to communicate your message
                  in a luxurious setting while making entertaining as easy as it
                  is elegant. Take advantage of the most unique and exciting way
                  to entertain in Utah with one of our exclusive club
                  memberships at Vivint Arena.
                </p>
                <Link href="">
                  <button className="px-3 py-1 my-3 text-yellow-300 duration-300 ease-in border border-yellow-300 rounded w-fit hover:bg-yellow-300 hover:text-black">
                    Learn More
                  </button>
                </Link>
              </div>
        ...
        <div className="w-full py-20 px-[10%]">
          {/* Luxury Suites */}
          <h3 className="py-5 text-3xl font-bold text-yellow-300">
            LUXURY SUITES
          </h3>
          <div className="flex flex-wrap justify-between">
            <div className="flex items-center w-full justify-center md:w-[48%] mb-20 text-2xl font-bold bg-center bg-cover h-[20rem] bg-eide_opacity">
              EIDE_BAILLY_SUITE_LEVEL
            </div>
            <div className="flex items-center w-full justify-center md:w-[48%] mb-20 text-2xl font-bold bg-center bg-cover h-[20rem] bg-exclusive_opacity">
              LEVEL 3 UDO LOUNGE
            </div>
            <div className="flex items-center w-full justify-center md:w-[48%] mb-20 text-2xl font-bold bg-center bg-cover h-[20rem] bg-loge_boxes">
              LOGE BOXES
            </div>
            <div className="flex items-center w-full justify-center md:w-[48%] mb-20 text-2xl font-bold bg-center bg-cover h-[20rem] bg-courtside">
              COURTSIDE SUITES
            </div>
          </div>
